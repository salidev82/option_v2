...
const ArbitrageFilter = (props: Props) => {
    ...
    const inputValues = useSelector((state: any) => state.arbitrageFilterSlice);
    ...
    const handleSelectChange = (field: any, value: any) => {
        dispatch(updateArbitrageFilter({ [field]: value }));
    };
                ...
                <div className="flex gap-3 rounded-sm items-end  ">
                    ...
                    <div>
                        ...
                        <Select dir="rtl"
                            ...
                            onValueChange={(value) => debouncedHandleSelectChange('option_type', value)} // Use debouncedHandleSelectChange
                        >
                    ...
                    <div>
                        <Toggle className={`${inputValues.active === false ? 'bg-blue-500 text-white' : ''}`} onClick={() => debouncedHandleSelectChange('active', false)} >
                            تمامی نماد ها
                        </Toggle>
                        <Toggle className={`${inputValues.active === true ? 'bg-blue-500 text-white' : ''}`} onClick={() => debouncedHandleSelectChange('active', true)} >
                            فعال
                        </Toggle>
                    </div>
