...
import ArbitrageFilter from './ArbitrageFilter'
...
import ArbitrageCalc from './ArbitrageCalc'
...
const Arbitrage = () => {
    ...
    const paramsFromLocalStorage = useSelector(
        (state: any) => state.arbitrageFilterSlice // Replace with the actual slice name used in the store
    );
    ...
    const getArbitrage = async () => {
        const response = await axios.get(`options_strategies/arbitrage`, {
                ...
                return <div className="text-md cursor-pointer text-center w-full flex items-center justify-center">
                    <Dialog >
                        ...
                        <DialogContent className="max-w-sm">
                            <ArbitrageCalc row={row.row.original} />
                        </DialogContent>
                    </Dialog>
    ...
    return (
        <div className='noTRBold arbitrageTable'>
            <ArbitrageFilter />
